...
DATABASES = {
    'default': {
        ...
        'NAME': 'recipe_db',             # Your database name
        'USER': 'root',                  # Or whatever username you set during MySQL install
        'PASSWORD': 'Naresh@1234',  # Replace with your actual MySQL root password
        'HOST': 'localhost',
        'PORT': '3306',
